...
while(True):
    W, H = 213, 96
    canRead = write_to_filelock('canRead.txt', 0, 'r')
    if canRead == '1':
        ...
        out = write_to_filelock('out.txt', "COLLISION:" + str(collision), 'w')

        out = write_to_filelock('canRead.txt', "0", 'w')

        out = write_to_filelock('DroneRead.txt', "1", 'w')
